...
describe('legal pages', () => {
  it('renders the privacy policy, referencing the support email and never claiming an attached file', () => {
  ...
  it('renders the terms of service, describing the download-link delivery mechanic', () => {
    render(<TermsPage />);
  ...
  it('renders the refund policy, stating digital goods are non-refundable once delivered', () => {
    render(<RefundsPage />);
  ...
  it('renders the contact page with a working mailto link', () => {
    render(<ContactPage />);
  ...
  it('never claims a PDF file is attached to the delivery email, on any legal page', () => {
